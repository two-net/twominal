...
const raccoon_1 = __webpack_require__(/*! ../panel/pets/raccoon */ "./src/panel/pets/raccoon.ts");
function randomName(type) {
    const collection = {
        ...
        ["raccoon" /* PetType.raccoon */]: raccoon_1.RACCOON_NAMES,
...
function addPetToPanel(petType, basePetUri, petColor, petSize, left, bottom, floor, name, stateApi) {
    ...
    try {
        if (!(0, pets_1.availableColors)(petType).includes(petColor)) {
            petColor = (0, pets_1.normalizeColor)(petColor, petType);
        }
    } catch(e) {
        petColor = 'brown';
    }
    const cleanBase = (basePetUri || '').replace(//+$/, '');
    const root = cleanBase + '/' + petType + '/' + petColor;
...
function recoverState(basePetUri, petSize, floor, stateApi) {
    ...
    if (!state || !state.petStates || state.petStates.length === 0) {
        petCounter = 1;
    }
    else {
...
const raccoon_1 = __webpack_require__(/*! ./pets/raccoon */ "./src/panel/pets/raccoon.ts");
...
function createPet(petType, el, collision, speech, size, left, bottom, petRoot, floor, name) {
    ...
    switch (petType) {
        ...
        case "raccoon" /* PetType.raccoon */:
            return new raccoon_1.Raccoon(...standardPetArguments, 3 /* PetSpeed.normal */);
        default:
...
function availableColors(petType) {
    switch (petType) {
        ...
        case "raccoon" /* PetType.raccoon */:
            return raccoon_1.Raccoon.possibleColors;
        default:
            throw new InvalidPetException("Pet type doesn't exist");
    }
}
...
class Chicken extends basepettype_1.BasePetType {
    label = 'chicken';
    static possibleColors = ["white" /* PetColor.white */, "brown" /* PetColor.brown */];
    sequence = {
        startingState: "sit-idle" /* States.sitIdle */,
        sequenceStates: [
            {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RACCOON_NAMES = exports.Raccoon = void 0;
const basepettype_1 = __webpack_require__(/*! ../basepettype */ "./src/panel/basepettype.ts");
class Raccoon extends basepettype_1.BasePetType {
    label = 'raccoon';
    static possibleColors = ["gray" /* PetColor.gray */, "gray_jimothy" /* PetColor.grayJimothy */];
    sequence = {
        startingState: "sit-idle" /* States.sitIdle */,
        sequenceStates: [
            {
